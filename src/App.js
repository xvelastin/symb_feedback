...
import CursorPositionPopup from "./components/cursorPositionPopup";


const DEV = false;

// set to navigation for dev, front page for publish
const homePage = DEV ?  Pages.NavigationPage : Pages.FrontPage;
...
export default function App() {
    ...
    return (
        <>
            {DEV ? <CursorPositionPopup/> : null } 
            {Display(pageDisplayed)}
        </>
    )
}
